...
function codeFamilyGuide(type, category, language) {
  ...
  const customEnvelope = (family, useNoun, riskNoun) => ({
    ...
    home: focus.place,
    use: es ? [`Usalo como ${useNoun} para ${stage}: incluye payload, sal, nonce, fecha, ruta y checksum.`, focus.useLine, `Es util para flujos privados de tokenizacion, QR, certificados, tickets y auditoria local.`] : [`Use it as a ${useNoun} for ${stage}: it includes payload, salt, nonce, timestamp, route, and checksum.`, focus.useLine, `It is useful for private tokenization, QR, certificates, tickets, and local audit flows.`],
    avoid: es ? [`No lo presentes como estandar publico auditado; ${named} es un formato propietario de OCG.`, `No lo uses para proteger ${riskNoun || focus.risk} si no va acompanado de cifrado real, control de claves y politicas de acceso.`, 'No reemplaza firmas, HMAC o cifrado autenticado cuando el sistema necesita garantias criptograficas externas.'] : [`Do not present it as a public audited standard; ${named} is an OCG proprietary format.`, `Do not use it to protect ${riskNoun || focus.risk} without real encryption, key control, and access policy.`, 'It does not replace signatures, HMAC, or authenticated encryption when external cryptographic assurance is required.'],
    where: es ? [focus.place, 'QR Vault y paquetes transportables.', 'Certificados privados, tickets, licencias y bitacoras locales.'] : [focus.place, 'QR Vault and transportable packets.', 'Private certificates, tickets, licenses, and local logs.'],
    notes: es ? [`Familia visible: ${badge || family}. Entropia declarada: ${bits}. Motor: ${engine}.`, focus.note, 'Para produccion enterprise, registra emisor, version, expiracion, revocacion y hash del payload original.'] : [`Visible family: ${badge || family}. Declared entropy: ${bits}. Engine: ${engine}.`, focus.note, 'For enterprise production, record issuer, version, expiry, revocation, and original payload hash.']
  });
...
function buildConcreteProfile(type, category, language) {
  ...
  return {
    headline: purpose,
    rows: [[es ? 'Salida exacta' : 'Exact output', output], [TL(language, 'validation'), validation], [TL(language, 'lifecycle'), lifecycle], [TL(language, 'storageRule'), storage], [TL(language, 'criticalRisk'), risk], [TL(language, 'enterpriseUse'), enterprise]],
...
function TechInfo({
  ...
  if (!type) {
    return React.createElement("div", {
      ...
      className: "ti-empty-mark",
      dangerouslySetInnerHTML: {
        __html: window.OCG_ICONS.brand(28)
      }
    }), React.createElement("div", {
      className: "ti-empty-t"
    }, TL(language, 'selectTitle')), React.createElement("div", {
      className: "ti-empty-d"
    }, TL(language, 'selectDesc')));
  }
  ...
  return React.createElement("div", {
    className: `ti ${density}`
  }, React.createElement("div", {
    className: "ti-head"
  }, React.createElement("div", {
    className: "ti-cat"
  }, categoryLabel), React.createElement("h2", {
    className: "ti-title"
  }, type.label), React.createElement("div", {
    className: "ti-badge-row"
  }, React.createElement("span", {
    className: "ti-pill"
  }, type.badge), React.createElement("span", {
    className: "ti-pill ti-pill-mono"
  }, type.std))), React.createElement("p", {
    className: "ti-about"
  }, about), React.createElement("p", {
    className: "ti-subabout"
  }, categoryOneLine(category, language)), React.createElement("div", {
    className: "ti-quickgrid"
  }, React.createElement("div", {
    className: "ti-quickcard"
  }, React.createElement("span", null, TL(language, 'outputFormat')), React.createElement("b", null, type.engine)), React.createElement("div", {
    className: "ti-quickcard"
  }, React.createElement("span", null, TL(language, 'bestFit')), React.createElement("b", null, guide.bestFit)), React.createElement("div", {
    className: "ti-quickcard"
  }, React.createElement("span", null, TL(language, 'posture')), React.createElement("b", null, securityPosture(type, category, language))), React.createElement("div", {
    className: "ti-quickcard"
  }, React.createElement("span", null, TL(language, 'commonHome')), React.createElement("b", null, guide.home))), React.createElement("div", {
    className: "ti-spec"
  }, React.createElement("div", {
    className: "ti-spec-row"
  }, React.createElement("span", {
    className: "ti-k"
  }, TL(language, 'engine')), React.createElement("span", {
    className: "ti-v"
  }, type.engine)), React.createElement("div", {
    className: "ti-spec-row"
  }, React.createElement("span", {
    className: "ti-k"
  }, TL(language, 'entropy')), React.createElement("span", {
    className: "ti-v"
  }, type.entropy)), React.createElement("div", {
    className: "ti-spec-row"
  }, React.createElement("span", {
    className: "ti-k"
  }, TL(language, 'searchSpace')), React.createElement("span", {
    className: "ti-v"
  }, type.space)), React.createElement("div", {
    className: "ti-spec-row"
  }, React.createElement("span", {
    className: "ti-k"
  }, TL(language, 'standard')), React.createElement("span", {
    className: "ti-v"
  }, type.std))), React.createElement("div", {
    className: "ti-concrete"
  }, React.createElement("div", {
    className: "ti-concrete-head"
  }, React.createElement("span", null, TL(language, 'concreteProfile')), React.createElement("b", null, TL(language, 'realPurpose'))), React.createElement("p", null, concrete.headline), React.createElement("div", {
    className: "ti-tagline"
  }, concrete.tags.map((tag, i) => React.createElement("span", {
    key: `ctag-${i}`
  }, tag))), React.createElement("div", {
    className: "ti-concrete-rows"
  }, concrete.rows.map(([key, value], i) => React.createElement("div", {
    className: "ti-concrete-row",
    key: `concrete-${i}`
  }, React.createElement("span", null, key), React.createElement("b", null, value))))), React.createElement("div", {
    className: "ti-section"
  }, React.createElement("h3", {
    className: "ti-h3"
  }, TL(language, 'whereUse')), React.createElement("ul", {
    className: "ti-ul"
  }, guide.use.map((row, i) => React.createElement("li", {
    key: `use-${i}`
  }, row)))), React.createElement("div", {
    className: "ti-section"
  }, React.createElement("h3", {
    className: "ti-h3"
  }, TL(language, 'whereNot')), React.createElement("ul", {
    className: "ti-ul ti-ul-warn"
  }, guide.avoid.map((row, i) => React.createElement("li", {
    key: `avoid-${i}`
  }, row)))), React.createElement("div", {
    className: "ti-section"
  }, React.createElement("h3", {
    className: "ti-h3"
  }, TL(language, 'typicalPlaces')), React.createElement("ul", {
    className: "ti-ul ti-ul-soft"
  }, guide.where.map((row, i) => React.createElement("li", {
    key: `where-${i}`
  }, row)))), React.createElement("div", {
    className: "ti-section"
  }, React.createElement("h3", {
    className: "ti-h3"
  }, TL(language, 'opNotes')), React.createElement("ul", {
    className: "ti-ul ti-ul-note"
  }, guide.notes.map((row, i) => React.createElement("li", {
    key: `note-${i}`
  }, row)))), React.createElement("div", {
    className: "ti-foot"
  }, React.createElement("div", {
    className: "ti-foot-row"
  }, React.createElement("span", null, TL(language, 'id')), React.createElement("b", null, type.id)), React.createElement("div", {
    className: "ti-foot-row"
