...
(async () => {
  ...
  assert(
    indexSource.includes('app/build/app.js?v=hashcod-spectrum-3')
      && indexSource.includes('app/styles.css?v=hashcod-reference-skin-20260605-9')
      && indexSource.includes('app/hashcod-spectrum.css?v=hashcod-spectrum-3'),
    'app-cache-buster'
  );
  assert(
    indexSource.includes('app/tech-info-visible.css?v=tech-info-visible-3'),
    'tech-info-visibility-layer'
  );
