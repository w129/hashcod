...
(async () => {
  ...
  assert(indexSource.includes('app/build/app.js?v=hashcod-reference-skin-20260605-5') && indexSource.includes('app/styles.css?v=hashcod-reference-skin-20260605-5'), 'app-cache-buster');
