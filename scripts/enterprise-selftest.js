...
(async () => {
  ...
  assert(indexSource.includes('app/build/app.js?v=hashcod-reference-skin-20260605-4') && indexSource.includes('app/styles.css?v=hashcod-reference-skin-20260605-4'), 'app-cache-buster');
