...
(async () => {
  ...
  assert(indexSource.includes('app/build/app.js?v=hashcod-reference-skin-20260605-2') && indexSource.includes('app/styles.css?v=hashcod-reference-skin-20260605-2'), 'app-cache-buster');
