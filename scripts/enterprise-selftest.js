...
(async () => {
  ...
  assert(indexSource.includes('app/build/app.js?v=hashcod-reference-skin-20260605-3') && indexSource.includes('app/styles.css?v=hashcod-reference-skin-20260605-3'), 'app-cache-buster');
