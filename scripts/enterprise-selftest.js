...
(async () => {
  ...
  assert(blindSpotSource.includes('access-qr-dock') && blindSpotSource.includes('blind-spot-shell-access') && blindSpotSource.includes('renderAccessQr') && blindSpotSource.includes('BSS-ACCESS-'), 'blind-spot-shell-access-qr');
